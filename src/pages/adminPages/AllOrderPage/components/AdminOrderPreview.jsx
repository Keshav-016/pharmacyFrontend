...
const AdminOrderPreview = () => {
    ...
    // const finalOrder = useSelector((state) => state.userOrders.viewingOrder);
    ...
    return (
        <>
            <div className="bg-[#EBF6F9] flex flex-col items-center justify-between min-h-[90vh]">
                <div className="   sm:w-[80%] w-[100%] grid grid-cols-12 mx-auto py-5  justify-start justify-items-start gap-5 lg:gap-0  max-w-[1200px]">
                    <div className="w-[100%] lg:col-span-7 xl:col-span-8 col-span-12 lg:px-2 sm-pe-7 px-5 sm-px-0">
                        <UserOrderPreview
                            subHeading="Order Details"
                            userOrder={userOrder}
                        />
                    </div>
                    <div className="w-[100%] lg:col-span-5 xl:col-span-4 col-span-12 lg:ps-2 ps-5">
                        <div className="lg:w-[100%] w-[95%] bg-white lg:p-5 p-4  lg:flex   flex-col gap-3 rounded-lg">
                            <h1 className=" font-default-font-family text-xl ps-4">
                                Order Offers
                            </h1>
                            <div className="p-2">
